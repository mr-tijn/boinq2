...
angular.module('boinqApp').controller('TrackController', ['$scope', 'Track', 'Datasource', 'TrackDatafile', 'TrackConversion', 'FileUploader', 'TrackConstants', 'DatasourceConstants', 
