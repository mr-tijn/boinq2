...
angular.module('boinqApp').factory('RecursionHelper', ['$compile', function($compile){
    return {
        /**
...
angular.module('boinqApp').directive('termTreeNode', function(RecursionHelper) {
...
angular.module('boinqApp').directive('termTreePicker', function() {
