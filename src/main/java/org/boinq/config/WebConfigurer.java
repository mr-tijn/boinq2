...
import org.boinq.web.filter.CachingHttpHeadersFilter;
import org.boinq.web.filter.StaticResourcesProductionFilter;
import org.boinq.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        if (env.acceptsProfiles(Constants.SPRING_PROFILE_PRODUCTION) || env.acceptsProfiles(Constants.SPRING_PROFILE_DOCKER)) {
